...
| [`Elu`](https://onnx.ai/onnx/operators/onnx__Elu.html) | ![FALLBACK](https://img.shields.io/badge/FALLBACK-FFAA00?style=flat&logoColor=white) |
...
| [`Mish`](https://onnx.ai/onnx/operators/onnx__Mish.html) | ![FALLBACK](https://img.shields.io/badge/FALLBACK-FFAA00?style=flat&logoColor=white) |
...
| [`Round`](https://onnx.ai/onnx/operators/onnx__Round.html) | ![FALLBACK](https://img.shields.io/badge/FALLBACK-FFAA00?style=flat&logoColor=white) |
...
| [`Softplus`](https://onnx.ai/onnx/operators/onnx__Softplus.html) | ![FALLBACK](https://img.shields.io/badge/FALLBACK-FFAA00?style=flat&logoColor=white) |
...
- **Executable directly (SUCCESS):** 113 (57.7%)
- **Executable directly (SUCCESS with complexification):** 0 (0.0%)
- **Executable via FALLBACK:** 63 (32.1%)
